...
import 'add_company_expense_page.dart';

class CompanyExpensesPage extends StatefulWidget {
  const CompanyExpensesPage({super.key});
...
class _CompanyExpensesPageState extends State<CompanyExpensesPage>
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final categories = await ExpenseService.getCompanyExpenseCategories();
      ...
      if (mounted) {
        ...
        LuxuryStatusDialog.show(
          ...
          message: 'Impossible de charger les dépenses de la société. Veuillez réessayer.',
        );
      }
    }
  }
  ...
  void _showAddExpenseDialog() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const AddCompanyExpensePage()),
    ).then((_) => _loadData());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ProtectedRoute(
      requiredPermissions: ['manage_company_expenses', 'view_company_expenses'],
      child: Scaffold(
        backgroundColor: Colors.transparent,
        extendBodyBehindAppBar: true,
        appBar: LuxuryAppBar(
          title: settings.translate('company_expenses'),
        ),
        body: _buildBody(settings),
        floatingActionButton: context.hasPermission('manage_company_expenses')
  ...
  Widget _buildSummaryCard(bool isDark, SettingsController settings) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            settings.translate('total_company_expenses'),
            style: TextStyle(
              fontSize: 14,
          ...
          Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: settings.translate('search_company_expenses'),
          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.business_rounded, color: AppTheme.accentGold, size: 24),
              ),
  ...
  Future<void> _handleApproval(int id, bool approve) async {
    ...
    try {
      final res = approve 
          ? await ExpenseService.approveExpense('company', id)
          : await ExpenseService.rejectExpense('company', id);
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            settings.translate('no_company_expenses_found'),
            style: TextStyle(
              fontSize: 18,
              fontWeight: FontWeight.bold,
          ...
          const SizedBox(height: 8),
          Text(
            settings.translate('add_first_company_expense'),
            style: TextStyle(
              fontSize: 14,
        ...
        return Transform.scale(
          ...
          child: Container(
            ...
            child: FloatingActionButton.extended(
              ...
              label: Text(
                settings.translate('add_company_expense'),
