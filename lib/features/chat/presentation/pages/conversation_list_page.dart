                ...
                onLongPress: () async {
                  final confirm = await showDialog<bool>(
                    ...
                    builder: (context) => AlertDialog(
                      ...
                      title: Text(settings.translate('delete_conversation') ?? 'Delete Conversation'),
                      content: Text(settings.translate('delete_convo_confirm') ?? 'Are you sure you want to delete this conversation? This action cannot be undone.'),
                      actions: [
                        TextButton(
                          onPressed: () => Navigator.pop(context, false),
                          child: Text(settings.translate('cancel'), style: const TextStyle(color: Colors.grey)),
                        ),
                        TextButton(
                              ...
                              leading: Stack(
                                children: [
                                  AvatarHelper.buildAvatar(
                                    user['photo']?.toString(),
                                    size: 40,
                                    initials: displayName.isNotEmpty ? displayName[0].toUpperCase() : null,
                                  ),
                                  if (isOnline)
                                    Positioned(
                                      right: 0,
