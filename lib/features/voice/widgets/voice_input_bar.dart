...
import 'package:fs_hub/widgets/media_picker_sheet.dart';
import 'package:fs_hub/widgets/upload_progress_overlay.dart';
...
class _ChatInputBarState extends State<ChatInputBar> {
  ...
  void _onChanged() {
    // Line counting logic removed - no longer needed
  }
  ...
  Future<void> _sendVoiceNote() async {
    try {
      ...
      try {
        ...
        print('[ChatInputBar._sendVoiceNote] Generated waveform: ${waveformData.length} chars');
      } catch (e) {
        print('[ChatInputBar._sendVoiceNote] Waveform generation failed: $e');
        // Continue without waveform - it's optional
      }

      print('[ChatInputBar._sendVoiceNote] Sending: $_recordedFilePath');
