-- Migration: Create depenses_societe table
...
CREATE INDEX idx_depenses_societe_date ON depenses_societe(date_depense);
CREATE INDEX idx_depenses_societe_categorie ON depenses_societe(categorie);
CREATE INDEX idx_depenses_societe_category_id ON depenses_societe(category_id);
